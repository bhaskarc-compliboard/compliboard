...
// The fixture itself — three companies, four people — lives in its own module so that
// `npm run db:restore` can count it without running this script. One definition, because
// a count copied into the restore is a count that drifts (DECISIONS.md §43).
